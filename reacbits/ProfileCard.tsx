...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  miniAvatarUrl = '/assets/img/profile.png',
  name = 'Javi A. Torres',
  ...
  const animationHandlers = useMemo(() => {
    ...
    const createSmoothAnimation = (
      ...
      const animate = (now: number) => {
        ...
        const currentX = startX + (toX - startX) * eased;
  ...
  return (
    <div ref={wrapRef} className={`pc-card-wrapper ml-auto ${className}`.trim()} style={cardStyle}>
      <section ref={cardRef} className="pc-card p-0 ml-auto">
